...
const ButtonOverviewContent = () => {
    ...
    return (
        <div className='flex bg-white'>
            {/* Main Content Area */}
            <div className="flex-1 pl-24 pt-12 bg-white">
                ...
                <section id="overview">
                    ...
                    {/* Images Container */}
                    <div className="p-6 bg-gray-100 flex justify-center gap-6" style={{ backgroundColor: '#FAFAFA' }}>
                ...
                <section id="anatomy">
                    ...
                    <div className="p-6 bg-gray-100 flex justify-center" style={{ backgroundColor: '#FAFAFA' }}>
                ...
                <section id="options">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                        {/* Primary Button */}
                        <div>
                            <div className="p-6 bg-gray-100" style={{ backgroundColor: '#FAFAFA' }}>
                    ...
                    <div className="p-6 bg-gray-100 flex justify-center gap-6 mb-8" style={{ backgroundColor: '#FAFAFA' }}>
                ...
                <section id="metrics">
                    ...
                    <hr className="border-t border-gray-700 mb-16" style={{ borderTop: '1px solid #3d3d3d', marginTop: '64px', marginBottom: '64px' }} />
                </section>
            ...
            {/* Side Navigation */}
            <div className='ml-12 mt-12 mr-16 mb-16 sticky top-12 bg-white'>
