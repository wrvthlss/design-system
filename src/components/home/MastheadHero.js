...
const MastheadHero = () => (
    <div className="hero-container relative bg-cover bg-center h-[625px] text-black p-8 lg:rounded-3xl" style={{ backgroundImage: 'url(/images/hero-bg-light.png)', marginTop: '-265px'}}>
