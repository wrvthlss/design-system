    ...
    return (
        <div className={mobile ? "p-0 my-5" : "mt-40"} style={{ maxWidth: mobile ? "none" : "360px"}}>
            <div className={mobile ? "flex" : "block"}>
                <img src={image} alt="Card image" className={`${mobile ? 'w-20 h-20' : 'w-full h-auto'}  image-card-image rounded-lg bg-white`} style={{ minWidth: mobile ? "80px" : "360px", minHeight: mobile ? "80px" : "240px" }} />
