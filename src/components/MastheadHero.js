...
const MastheadHero = () => (
    <div className="relative bg-cover bg-center h-[620px] rounded-lg text-black p-8" style={{ backgroundImage: 'url(/images/hero-bg-light.png)', marginTop: '-330px' }}>
        <div className="absolute inset-0 bg-gradient-to-r rounded-lg from-white to-transparent"></div> {/* Adjusted gradient direction */}
