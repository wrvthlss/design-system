...
//                 style={{
//                     paddingTop: '72px',
//                     paddingRight: '20px', // 20px for mobile by default
//                     paddingBottom: '0px',
//                     paddingLeft: '96px',
//                     color: '#000',
//                     backgroundColor: '#fff',
...
//                                 activeTab === index ? 'font-bold text-black' : 'text-gray-500'
//                             }`}
//                             onClick={() => handleClick(index)}
//                         >
//                             {tab}
...
//                     ))}
//                     <div
//                         className="absolute bg-green-500 h-1 transition-all duration-300 ease-out"
//                         style={{ left: `${barPosition}px`, width: `${barWidth}px`, bottom: 0 }}
//                     />
//                 </div>
//             </div>
//         </>
